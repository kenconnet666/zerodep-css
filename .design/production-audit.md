...
0.1.0 基线 9d07fce / CI 35764976781 已完整通过。追加的系统亮暗预设与强化审计代码基线 244ce13 / CI 35779421997 七个 job 均成功；完整发现和回归见 [追加审计](presets-audit-plan.md)。0.2.0 最终元数据与文档提交仍须同一完整 CI 复核。

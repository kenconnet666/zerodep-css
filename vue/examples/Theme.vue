...
const props = withDefaults(defineProps<{ initialDark?: boolean }>(), { initialDark: false });
...
<template>
  <section :class="isDark ? dark : light" :data-preset-theme="props.initialDark ? 'dark' : 'light'">
